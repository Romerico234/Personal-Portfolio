...
function useZoomAnimation(zoom, offsetX, offsetY, zoomWrapperRef) {
  const zoomAnimation = React10.useRef();
  const zoomAnimationStart = React10.useRef();
...
function useZoomSensors(zoom, maxZoom, disabled, changeZoom, changeOffsets, zoomWrapperRef) {
  ...
  const pinchZoomDistance = React10.useRef();
...
function ResponsiveImage(props) {
  ...
  return React10.createElement(
    React10.Fragment,
    null,
    preload && preload !== current && React10.createElement(ImageSlide, { key: "preload", ...props, slide: { ...image, src: preload, srcSet: void 0 }, style: { position: "absolute", visibility: "hidden", ...style }, onLoad: () => handlePreload(preload), render: {
      ...render,
      iconLoading: () => null,
      iconError: () => null
    } }),
